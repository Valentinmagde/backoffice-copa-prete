  ...
  const menuItems = [
    {
      ...
      value: `/settings/${id}/profile-settings${from ? `?from=${from}` : ''}`,
    },
    // {
    //   label: 'Profil',
    //   value: `/settings/${id}/profile-settings/profile${from ? `?from=${from}` : ''}`,
    // },
    {
      label: 'Mot de passe',
      value: `/settings/${id}/profile-settings/password${from ? `?from=${from}` : ''}`,
    },
    // {
    //   label: 'Team',
    //   value: '/settings/profile-settings/team',
    // },
    // {
    //   label: 'Billing',
    //   value: '/settings/profile-settings/billing',
    // },
    // {
    //   label: 'Notifications',
    //   value: '/settings/profile-settings/notification',
    // },
  ];
              ...
              {menuItems.map((menu, index) => (
                <Link
                  ...
                  className={cn(
                    ...
                    menu.value.split('?')[0].toLowerCase() === pathname
