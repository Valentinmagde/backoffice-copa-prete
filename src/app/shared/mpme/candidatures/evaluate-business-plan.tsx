      ...
      {(() => {
        ...
        const handleSave = async () => {
          ...
          try {
            ...
            const updated = await businessPlanApi.updateFinancialData(businessPlan.id, payload);
            queryClient.setQueryData(['business-plan', 'beneficiary', beneficiaryId], (old: any) => ({
              ...(old ?? {}),
              ...(updated ?? {}),
            }));
