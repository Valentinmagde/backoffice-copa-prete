...
import { mpmeInscritsColumns } from './columns';
import Filters from './mpme-inscrits-filters';
...
export default function MPMEInscritsTable({
  data,
  isLoading,
  className,
  variant = 'modern',
  ...
  const { table, setData } = useTanStackTable<MPMEInscrit>({
    tableData: data,
    columnConfig: mpmeInscritsColumns(false),
    options: {
      initialState: {
        pagination: {
